...
execute if block ~ ~-1 ~ cave_air run setblock ~ ~-1 ~ podzol
execute if block ~ ~-1 ~ void_air run setblock ~ ~-1 ~ podzol
...
execute align xz run summon area_effect_cloud ~0.5 ~ ~0.5 {Duration:2147483647,Particle:"underwater",Tags:["pg_grave","pg_spawnedGrave"],Radius:0.1}
...
function player_graves:get_grave_coords
