...
execute positioned ~ ~300 ~ run execute as @e[type=minecraft:area_effect_cloud,tag=pg_graveItems,limit=1,sort=nearest] at @s run execute as @e[type=minecraft:item,scores={pg_itemAge=0..1}] run data merge entity @s {Motion:[0.0d,0.0d,0.0d],PickupDelay:0}
